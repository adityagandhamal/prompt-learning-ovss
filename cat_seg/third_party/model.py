...
class VisualTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, dense=False):
        ...
        # ###########
        # print("Inside CLIP ViT... after self.conv1(x)")
        # print(x.shape)
        # print(hey)
        ...
        print("Inside CLIP ViT... after adding pos emb + cls token")
        print(x.shape)
        # x = random_masking(x, masking_ratio)
        x = self.ln_pre(x)
    ...
    def random_masking(self, x, mask_ratio):
        """
        x.shape <-- # batch,length,dim <-- verify this with earlier above statement
        https://github.com/facebookresearch/mae L:129 to L:140
