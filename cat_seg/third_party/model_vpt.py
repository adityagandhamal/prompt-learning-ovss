...
class PromptLearner(nn.Module):
    ...
    def forward(self, classnames):
        ...
        # Reconstruct prompts by merging prefix, context, and suffix
...
class CLIP(nn.Module):
    ...
    def encode_text(self, classnames):
        ...
        prompts, tokenized_prompts = self.CoOp(classnames)
...
def build_model(state_dict: dict, prompt_depth=0, prompt_length=0, tp_length=0, tp_dim=0):
    ...
    model = CLIP(
        ...
        #classnames=classnames, 
        tp_length=tp_length, tp_dim=tp_dim, #tokenizer=tokenizer,
