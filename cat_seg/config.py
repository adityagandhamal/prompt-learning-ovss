...
def add_cat_seg_config(cfg):
    ...
    # cfg.MODEL.SEM_SEG_HEAD.VISUAL_PROMPT_DEPTH = 0
    # cfg.MODEL.SEM_SEG_HEAD.VISUAL_PROMPT_LENGTH = 0
    # cfg.MODEL.SEM_SEG_HEAD.TEXTUAL_PROMPT_DEPTH = 0
    # cfg.MODEL.SEM_SEG_HEAD.TEXTUAL_PROMPT_LENGTH = 0
